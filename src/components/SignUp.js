...
const SignUp = (props) => {
    ...
    return (
        <div className="container">
         <h2>SignUp to continue with MERN-noteBook</h2>
            <form onSubmit={handleSubmit}>
                <div className="mb-3">
                    <label htmlFor="exampleInputEmail1" className="htmlForm-label">Name</label>
                    <input type="name" className="htmlForm-control" name='name' onChange={onChange} value={credentials.name} id="exampleInputEmail1" aria-describedby="emailHelp" />
                </div>
                <div className="mb-3">
